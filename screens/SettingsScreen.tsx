...
const SettingsScreen = () => {
    ...
    const openActionSheet = (settingsOption: SettingsOptions) => {
        if (settingsOption === SettingsOptions.LANGUAGE) {
            setSheetTitle(t('SettingsSection.chooseLanguageTitle'));
            const sheetOptions = [
                { title: t('SettingsSection.englishTitle'), iconName: "language", iconColor: COLORS.accent },
                { title: t('SettingsSection.serbianTitle'), iconName: "language", iconColor: COLORS.accent },
                { title: t('SettingsSection.croatianTitle'), iconName: "language", iconColor: COLORS.accent },
            ];
        ...
        <SafeAreaView style={sharedStyles.safeLayoutContainerStyle}>
            <ScrollView style={sharedStyles.scrollContainer}>
                <View style={[sharedStyles.rowContainer, sharedStyles.bottomBorder]}>
                    <Text style={sharedStyles.sectionTitle}>{t('SettingsSection.changeLanguageTitle')}</Text>
                    <TouchableOpacity
